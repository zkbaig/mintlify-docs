...
<Tabs>
  <Tab title="Funding lifecycle ladder">
    | Stage | Milestone focus | Typical capital |
    | --- | --- | --- |
    | **Pre-seed** | Problem validation and MVP | Founders, friends/family, accelerators |
    | **Seed** | Early traction and team build | Angels, seed funds |
    | **Series A** | Repeatable growth engine | VC |
    | **Series B/C** | Scale and global expansion | Growth VC |
    | **Exit** | Acquisition or IPO | Strategic buyers, public markets |
  </Tab>
