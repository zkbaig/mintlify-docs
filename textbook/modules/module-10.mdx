...
- **Limited partnership:** Limited partners (LPs) provide capital; general partners (GPs) manage investments.
...
- **Limited Partner Advisory Committee (LPAC):** Advisory committee overseeing conflicts and extensions.
- **Distributions to paid-in (DPI), total value to paid-in (TVPI), and internal rate of return (IRR):** Key LP performance metrics.
...
Use this lens table to compare priorities by stakeholder so you can see where incentives align or diverge.
...
The table below shows how fees reduce investable capital and how carry is calculated after profits.
...
### Mini-exercise: LP diligence checklist

Review a hypothetical GP pitch deck and answer:

1. What is the fund’s target DPI, TVPI, and IRR, and how do they compare to prior funds?
2. How much GP commitment is there, and who is providing it?
3. What is the fee schedule over the fund life (including step-downs)?
4. How concentrated is the portfolio strategy by stage, sector, and geography?
5. What are the terms and governance rights granted to the LPAC?
