...
Funds follow a predictable cash flow arc: **fees and capital calls early, deployment mid-cycle, and distributions late**.
...
### Performance metrics: DPI, TVPI, and IRR

Use these metrics together to see **liquidity timing** and **total value**.
...
### LP due diligence questions (checklist)

Use this checklist when reviewing a GP pitch deck.
...
### Negotiation case: Horizon Seed Fund III
