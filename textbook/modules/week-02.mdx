...
<Steps>
  <Step title="Score the matrix">
    Rate InNovaTech across the nine Venture Evaluation Matrix factors using evidence from the case.
  </Step>
  <Step title="Diagnose deal-breakers">
    Identify the two lowest scores and explain why they are risky.
  </Step>
  <Step title="Design the fix">
    Propose one experiment or hire to lift each weak factor.
  </Step>
</Steps>

<Tabs>
  <Tab title="Pitch deck drill">
    Outline a 10-slide deck with one slide per evaluation dimension (need, solution, team, market, model, traction, etc.).
  </Tab>
  <Tab title="Business plan drill">
    Draft the two sections investors will scrutinize most: go-to-market assumptions and unit economics.
  </Tab>
</Tabs>
