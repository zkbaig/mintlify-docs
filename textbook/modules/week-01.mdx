...
<Steps>
  <Step title="Define the funding need">
    Estimate the next milestone cost for GreenRidge (capacity expansion, staffing, equipment).
  </Step>
  <Step title="Pick the capital source">
    Choose a funding mix (angel, loan, or VC) and justify why it fits the milestone.
  </Step>
  <Step title="Stress-test the trade-offs">
    Note dilution, control, and exit pressure implications for each option.
  </Step>
</Steps>

<AccordionGroup>
  <Accordion title="Exit math drill">
    If a VC invests $2M for 20% ownership and needs a 10× return, what exit value is required?
    **Answer:** $100M (VC needs $20M; $20M ÷ 20% = $100M).
  </Accordion>
  <Accordion title="Founder choice check">
    List one reason Nate might choose a loan over VC and one reason he might accept VC anyway.
  </Accordion>
</AccordionGroup>
