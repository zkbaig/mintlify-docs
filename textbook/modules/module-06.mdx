...
- **No-shop clause:** Exclusivity window that bars the company from soliciting other offers while diligence runs.
- **Vesting:** Earned ownership over time to keep founders and key hires committed.
- **Drag-along:** Majority holders can force minority holders to join an approved sale.
...
**Lead-in:** Use the table to compare how participating preferred “double dips” in a modest exit versus a non-participating alternative.
...
**Takeaway:** Participation shifts more value away from common stock at mid-range exits, even when the headline valuation looks strong.
...
**Takeaway:** Non-participating preferences mostly matter in **low-to-mid exits**. At high exits, the investor converts and participates like common.
