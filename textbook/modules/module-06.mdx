...
- **Liquidation preference:** The contractual priority of payouts on exit; 1× non-participating remains the standard baseline.
- **Participating preferred:** A structure that combines the preference with pro-rata participation, effectively creating a “double dip.”
- **Anti-dilution:** Protection against down rounds that adjusts the investor’s conversion price (weighted-average versus full-ratchet).
- **Vesting:** Earned ownership over time that preserves incentives for founders and key hires.

### Control terms

- **Protective provisions:** Investor consent rights that allow vetoes on major corporate actions.
- **No-shop clause:** An exclusivity period that prevents the company from soliciting alternative offers while diligence proceeds.
- **Drag-along:** A mechanism allowing majority holders to require minority holders to participate in an approved sale.
...
- **Participation:** Whether investors get preference and pro rata.
...
**Takeaway:** Participation shifts more value away from common stock at mid-range exits, even when the headline valuation looks strong. This distinction is central to evaluating whether a high valuation truly benefits founders.
